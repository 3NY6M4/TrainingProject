...
<body>
<form:form method="post" modelAttribute="caloricCalculator" action="/caloricCalculators/addCaloricCalculator">
<form:hidden path="id"/>
...
<form:errors path="weight"/><label>(w kg)</label><br/>
<label>Wzrost</label>
<form:input path="height"/>
<form:errors path="height"/><label>(w cm)</label><br/>
<label>Wiek</label>
<form:input path="age"/>
